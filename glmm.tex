...
\usepackage{listings}
\lstset{language=R, keywordstyle=\color{black}, frameround=fttt, basicstyle=\ttfamily\small}
...
% \subsubsection{Remarks about models for time series}
% \label{sec:remarksaboutmodelsfortimeseries}
