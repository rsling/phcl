\fbox{\begin{minipage}{\textwidth}
  ...
  \begin{refsection}
  \nocite{WolkEa2013}
  \addtocategory{boldentry}{WolkEa2013}
  ...
  For both constructions, carefully designed sampling protocols were used (see their Sec.~4).
  ...
  However, it is the advantage of random effects modeling that it can deal with a situation where categories have low numbers of observations (see \textit{shrinkage}, Sec.~\ref{sec:choosingbetweenrandomandfixedeffects}).
...
\fbox{\begin{minipage}{\textwidth}
  ...
  \begin{refsection}
  \nocite{Gries2015}
  \addtocategory{boldentry}{Gries2015}
  \toggletrue{bbx:boldentries}
  \printbibliography[heading=none]
  \end{refsection}
